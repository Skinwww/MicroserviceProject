...
namespace OrderApi.Infrastructure.Repositories
{
    public class OrderRepository(OrderDbContext context, IPublishEndpoint publishEndpoint) : IOrderRepository
    {
        ...
        public async Task<Response> DeleteAsync(int orderId)
        {
            try
            {
        ...
        public async Task<Order> FindByIdAsync(int id)
        {
            try
            {
                ...
                if (order is null)
                {
                    LogException.LogToConsole($"Заказ с Id = {id} не найден.");
                }
                return order;
            }
            catch (Exception ex)
        ...
        public async Task<OrderSummaryDTO> GetOrderSummaryAsync(int orderId)
        {
            ...
            if (productInfo.Name == null || productInfo.Volume == null || productInfo.Type == null) return null!;
